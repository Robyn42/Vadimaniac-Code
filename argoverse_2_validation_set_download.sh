...
## Download script for the Argoverse 2 motion forecasting "validation" dataset housed in the Argoverse s3 storage location.
...
## It creates an argoverse_2_data/motion-forecasting/val folder in the current working directory.
...
export INSTALL_DIR=./ && \
    ...
    s5cmd --no-sign-request cp s3://argoai-argoverse/av2/motion-forecasting/val/* argoverse_2_data/motion_forecasting/val     >> /dev/null && echo "Installed motion_forecasting" 
