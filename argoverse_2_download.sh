...
## It creates an argoverse_2_data folder in the current working directory.
...
export INSTALL_DIR=./ && \
    ...
    s5cmd --no-sign-request cp s3://argoai-argoverse/av2/motion-forecasting/val/000* argoverse_2_data/motion_forecasting     >> /dev/null && echo "Installed motion_forecasting" 
